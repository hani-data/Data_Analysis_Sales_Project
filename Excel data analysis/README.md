...
Data main → داده‌های خرید شامل تاریخ شمسی و ستون تبدیل‌شده به تاریخ میلادی (با استفاده از ماکرو).
...
تصویر اول – اسلایسر نام محصول و ماه فروش

نمودار تعاملی که نشان می‌دهد در هر ماه دقیقاً چه کالاهایی فروش رفته‌اند.

تصویر دوم – جدول و نمودار خطی سود محصولات

شامل پیوت تیبل با مجموع فروش کل هر محصول، میانگین سود واقعی و میانگین درصد سود هر محصول. این مقادیر با رنگ‌بندی Conditional Formatting به سه دسته‌ی رنگی سبز (پرسود)، زرد (میان‌سود) و قرمز (کم‌سود) تقسیم شده‌اند.

نمودار خطی نیز همین دسته‌بندی را نمایش می‌دهد.

تصویر سوم – فروش ماهانه کل اقلام

پیوت تیبل و نمودار میله‌ای که نشان می‌دهد در هر ماه مجموع اقلام فروخته‌شده چقدر بوده و چگونه فروش در برخی ماه‌ها به دلیل تخفیفات یا تقاضای فصلی دچار نوسان شده است.
...
Data main → Purchase data with both Persian and converted Gregorian dates (via macro).
...
Screenshot 1 – Product & Month Slicer

Displays which products were sold in each month.
...
Screenshot 3 – Monthly Sales Volume Overview

Bar chart showing total sold units by month — seasonal fluctuations caused by discounts or demand changes are clearly visible.
